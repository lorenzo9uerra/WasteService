		...
		return { //this:ActionBasciFsm
				...
				state("idle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t016",targetState="handleAsk",cond=whenRequest("storageAsk"))
					transition(edgeName="t017",targetState="handleDeposit",cond=whenDispatch("storageDeposit"))
				}	 
