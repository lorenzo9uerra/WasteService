...
class Pathexec2 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("doMoveTurn") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_doMoveTurn", 
							scope, context!!, "local_tout_pathexec2_doMoveTurn", 300.toLong() )
					}
					 transition(edgeName="t01",targetState="nextMove",cond=whenTimeout("local_tout_pathexec2_doMoveTurn"))   
				}	 
