...
package it.unibo.pro_dep_trolley
...
class Pro_dep_trolley ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("handleDeposit") { //this:State
					action { //it:State
						...
						delay(500) 
						forward("storageDeposit", "storageDeposit($CarryingType,$CarryingAmount)" ,"pro_dep_storagemanager" ) 
						 CarryingType = ""  
						 CarryingAmount = 0.0  
